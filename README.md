...
🔭 Aspiring Software Engineer passionate about building practical software solutions.

🌱 Currently strengthening Java, DSA, Spring Boot, REST APIs and Machine Learning.

👯 Open to collaborating on Software Development, AI/ML and Open Source projects.

💬 Ask me about Java, DSA, Python, Web Development, Machine Learning and DBMS.

🚀 Passionate about solving real-world problems through software and intelligent applications.
...
🔗 **Live Project:**  
https://codec-2-spam-email-classifier-8kn4livww95r8aswbu7ggp.streamlit.app/

---

## 🎓 AI for Inclusive Education Platform

A web platform focused on improving accessibility and creating a more
inclusive learning experience for students.

**Tech Stack:** React • HTML • CSS

🔗 **Live Project:**  
https://kanikepreethi98-source.github.io/impactmakers/

---

## 🤖 Customer Churn Prediction

A Machine Learning project developed to predict customer churn and identify
...
A Machine Learning based recommendation system designed to recommend movies
based on user preferences and similarity between movie data.
...
An AI-based application developed for voice recognition using Python.

**Tech Stack:** Python • Artificial Intelligence
...
`Python` • `Machine Learning` • `Streamlit` • `GitHub`

---

# 🧠 DSA & Problem Solving

💻 Actively practicing Data Structures & Algorithms for Software Engineering
interviews.
